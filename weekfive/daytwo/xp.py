...
beginsky = Family('Beginsky', [{'name': 'Michael', 'age': 35, 'gender': 'Male', 'is_child': False}, {
...
class TheIncredibles(Family):
    ...
    def incredible_presentation(self):
        for person in self.members:
            print(
                f"{person['name']} your incredible name is {person['incredible_name']} and your incredible power is {person['power']}")


incredibles = TheIncredibles('Parr', [
    {'name': 'Bob', 'age': 40, 'gender': 'Male', 'is_child': False,
        'power': 'super stregnth', 'incredible_name': 'Mr. Incredible'},
...
incredibles.born(name='Baby Jack', gender='Male',
                 power='Unknown', incredible_name='SuperJack')
print(incredibles)
incredibles.incredible_presentation()
